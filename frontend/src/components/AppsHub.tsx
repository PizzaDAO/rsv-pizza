...
const apps: AppItem[] = [
  ...
  // Preview features
  {
    ...
    icon: Handshake,
    status: 'preview',
    previewUrl: 'rsvpizza-git-feature-basil-20144-sponsor-crm-pizza-dao.vercel.app',
  },
  {
    id: 'venue',
    name: 'Venue',
    ...
    icon: MapPin,
    status: 'preview',
    previewUrl: 'rsvpizza-git-feature-olive-97159-venue-widget-pizza-dao.vercel.app',
  },
  {
    id: 'music-dj',
    name: 'Music / DJ',
    ...
    icon: Music,
    status: 'preview',
    previewUrl: 'rsvpizza-git-feature-buffalo-69550-music-widget-pizza-dao.vercel.app',
  },
  {
    id: 'reports',
    name: 'Reports',
    ...
    icon: BarChart3,
    status: 'preview',
    previewUrl: 'rsvpizza-git-mozzarella-66712-report-widget-pizza-dao.vercel.app',
  },
  {
    id: 'staffing',
    name: 'Staffing',
    ...
    icon: UserCog,
    status: 'preview',
    previewUrl: 'rsvpizza-git-jalapeno-66707-staffing-widget-pizza-dao.vercel.app',
  },
  {
    id: 'displays',
    name: 'Displays',
    ...
    icon: Monitor,
    status: 'preview',
    previewUrl: 'rsvpizza-git-tomato-27547-displays-widget-pizza-dao.vercel.app',
  },
  {
    id: 'raffle',
    name: 'Raffle',
    ...
    icon: Ticket,
    status: 'preview',
    previewUrl: 'rsvpizza-git-diavola-67656-raffle-widget-pizza-dao.vercel.app',
  },
  {
    id: 'budget',
    name: 'Budget',
    ...
    icon: Calculator,
    status: 'preview',
    previewUrl: 'rsvpizza-git-stuffed-crust-29007-budget-pizza-dao.vercel.app',
  },
  {
    id: 'party-kit',
    name: 'Party Kit',
    ...
    icon: Package,
    status: 'preview',
    previewUrl: 'rsvpizza-git-brick-oven-75090-party-kit-pizza-dao.vercel.app',
  },
  {
    id: 'marketing-promo',
    ...
    icon: Megaphone,
    status: 'preview',
    previewUrl: 'rsvpizza-git-woodfired-54438-promo-widget-pizza-dao.vercel.app',
  },
  {
    id: 'waitlist',
    name: 'Waitlist',
    ...
    icon: ListOrdered,
    status: 'preview',
    previewUrl: 'rsvpizza-git-feature-sausage-63975-waitlist-pizza-dao.vercel.app',
  },
