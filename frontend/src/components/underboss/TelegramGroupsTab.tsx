 ...
 * and per-city Test / Refresh buttons.
 *
 * provola-58505: the inbound capture suite was retired (the bot token is owned
 * by the moltobene service, so rsvpizza never received updates). There are no
 * pending captures to assign anymore — missing cities are filled lazily on
 * demand from moltobene server-side (see sendToCityGroup) or via the admin
 * sync-from-moltobene backfill.
 */
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-theme-text-muted mb-4">
          Missing cities are filled automatically from MoltoBene the first time a reminder/broadcast is sent. Use Refresh to pull a city's group on demand.
        </p>
