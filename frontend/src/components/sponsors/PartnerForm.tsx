...
export function PartnerForm({
  ...
  const isEditing = isCrm ? !!sponsor : !!partnerData;
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-6">
          ...
          {/* Intake Form — CRM mode, editing only */}
