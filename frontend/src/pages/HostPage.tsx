...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, Music } from 'lucide-react';
...
type TabType = 'details' | 'pizza' | 'guests' | 'photos' | 'music';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'music') ? tab : 'details';
