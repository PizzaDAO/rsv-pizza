...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, MapPin } from 'lucide-react';
...
type TabType = 'details' | 'venue' | 'pizza' | 'guests' | 'photos';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'venue') ? tab : 'details';
