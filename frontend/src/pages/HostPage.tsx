...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, Megaphone } from 'lucide-react';
...
type TabType = 'details' | 'pizza' | 'guests' | 'photos' | 'promo';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'promo') ? tab : 'details';
