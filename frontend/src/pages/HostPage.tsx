...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, DollarSign } from 'lucide-react';
...
type TabType = 'details' | 'pizza' | 'guests' | 'photos' | 'sponsors';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'sponsors') ? tab : 'details';
