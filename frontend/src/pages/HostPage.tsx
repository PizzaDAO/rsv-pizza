...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, Wallet } from 'lucide-react';
...
type TabType = 'details' | 'pizza' | 'guests' | 'photos' | 'budget';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'budget') ? tab : 'details';
