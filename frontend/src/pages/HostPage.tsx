...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, UserPlus } from 'lucide-react';
...
type TabType = 'details' | 'pizza' | 'guests' | 'photos' | 'staff';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'staff') ? tab : 'details';
