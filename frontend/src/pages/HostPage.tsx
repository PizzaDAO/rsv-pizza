...
import { Loader2, AlertCircle, Settings, Pizza, Users, Camera, Monitor } from 'lucide-react';
...
type TabType = 'details' | 'pizza' | 'guests' | 'photos' | 'displays';
...
function HostPageContent() {
  ...
  const activeTab: TabType = (tab === 'guests' || tab === 'pizza' || tab === 'photos' || tab === 'displays') ? tab : 'details';
